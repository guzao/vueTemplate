                ...
                <div  class="flex flex-col flex-1">
                    ...
                    <el-form :model="form" :rules="rules" ref="fromInstance">
                        ...
                        <el-form-item prop="username">
                            <el-input v-model="form.username" @keyup.enter.native="handleLogin" :placeholder="`${t('common.placeholder')}${t('login.name')}`" class="h-[48px]" :prefix-icon="User" clearable />
                        </el-form-item>
    
                        <el-form-item prop="password">
                            <el-input v-model="form.password" @keyup.enter.native="handleLogin" :placeholder="`${t('common.placeholder')}${t('login.password')}`" type="password" class="h-[48px]"  :prefix-icon="Lock" clearable />
                        </el-form-item>
    
                        <el-form-item prop="code" v-if="systemConfig.baseConfig.captchaEnabled">
                            <el-input v-model="form.code" @keyup.enter.native="handleLogin" :prefix-icon="Discount" class="h-[48px]"  clearable   
                            :placeholder="`${t('common.placeholder')}${t('login.imgCode')}`">
                                <template #suffix >
                    ...
                    <div class="flex flex-1 h-full items-end">
                        <el-button class="flex-1" type="primary" :loading="loading" @click="handleLogin">{{ t('login.login')  }}</el-button>
                    </div>
