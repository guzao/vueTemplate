...
<template>
    <ul>
        ...
        <li class="px-[16px] py-[20px] mb-[8px] sub_park_overview_item last:mb-0" v-for="item in deivceGroupList" :key="item.id">
            ...
            <div class="sub_park_overview_item_bg min-h-[52vh]">
                ...
                <div class="flex justify-start">
                    ...
                    <ul class="grid grid-cols-3 gap-[16px] mt-[40px] w-[884px]">
                        ...
                        <li
                            class="h-[166px] bg-[var(--theme-white-bg)]   pl-[12px] pt-[10px] relative">
                        ...
                        <li
                            ...
                            <div class="flex mt-[20px] items-center">
                                ...
                                <div class="text-[24px] text-[var(--charge)] mr-[4px] f-dinb font-bold"> {{ toFixed(item.soc) }}
                                </div>
